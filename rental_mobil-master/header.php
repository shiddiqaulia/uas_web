    ...
    <div class="jumbotron pt-4 pb-4">
        <div class="row">
            ...
            <div class="button col-sm-8">
                <button type="button" class="btn btn-primary" onclick="window.location.href='pageLogin.php'">Login</button>
                <a class="btn btn-secondary text-white" data-toggle="modal" data-target="#modelId">Daftar</a>
            </div>
            <?php } ?>
        </div>
    </div>
